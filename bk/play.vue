            ...
            <div class="main-box runoff clear">
                <div class="main clear">
                    ...
                    <div class="newCol">
                        <ul class="clear">
                            <li class="good">
                                <a href="javascript:;" class="goods" title="顶">
                                    <i></i>
            ...
            <div class="bottomBox clear">
                <div class="commentBox lf">
                    ...
                    <div class="commentInput">
                        ...
                        <div class="toComment">
                            <div class="inputBox">
                                <textarea id="commentInput" placeholder="我来说两句..."></textarea>
                            </div>
                            <div class="control clear">
                                ...
                                <div class="rt">
                                    <a href="javascript:;" class="send">发布</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="commentList">
                        <ul>
                            <li class="item clear">
                                <div class="avatar lf">
                                    <a href="javascript:;">
                                        <img src="../assets/image/avatar/defaultAvt.jpg">
                                    </a>
                                </div>
                                <div class="content lf">
                                    <p><a href="javascript:;">Lin_HR</a> <span>2017-12-24</span></p>
                                    <div>Hello World</div>
                                </div>
                            </li>
                            <li class="item clear">
